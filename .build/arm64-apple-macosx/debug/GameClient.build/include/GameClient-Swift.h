...
#ifndef GAMECLIENT_SWIFT_H
#define GAMECLIENT_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="GameClient",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSCoder;
@class SKView;
/// SpriteKit scene responsible for visualizing the current <code>GameState</code>.
/// Important: this scene never decides game rules; it only renders/animates.
SWIFT_CLASS("_TtC10GameClient9GameScene")
...
SWIFT_CLASS("_TtC10GameClient14KeyCaptureView")
